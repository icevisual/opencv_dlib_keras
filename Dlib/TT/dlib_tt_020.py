...
predictor_path = index.storage_path("model\\shape_predictor_68_face_landmarks.dat")
# 存放人脸图片的路径
face_directory_path = index.storage_path("images\\faces")
# 获取人脸分类器
detector = dlib.get_frontal_face_detector()
# 获取人脸检测器
predictor = dlib.shape_predictor(predictor_path)
# 传入的命令行参数
for f in index.get_faces():
    # 图片路径，目录+文件名
